package com.laioffer.snow.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.laioffer.snow.service.GameService;
import com.laioffer.snow.service.TwitchException;
...
public class GameController {
    ...
    public void getGame(@RequestParam(value = "game_name", required = false)
                        String gameName, HttpServletResponse response) throws IOException, ServletException {
