...
import com.laioffer.snow.entity.db.Item;
import com.laioffer.snow.entity.db.ItemType;
import com.laioffer.snow.entity.response.Game;
...
public class GameService {
    private static final String TOKEN = "Bearer fuw7mfee643n57x3i4tgkqkut2f00t";
    private static final String CLIENT_ID = "lpl2zu97e928ksznr7iephp94snytt";
    ...
    private String searchTwitch(String url) throws TwitchException {
        ...
        ResponseHandler<String> responseHandler = response -> { //java lamada writing style
...
//        return getGameList(searchTwitch(buildGameURL(TOP_GAME_URL, "", limit))); == the following three lines
